import { View, Text, TouchableOpacity, Image, Dimensions, Platform, ScrollView,StyleSheet , FlatList } from 'react-native'
...
const umzugDE = [
  {"id": 251, "text": "Du schaffst das, PLACEHOLDER! Jeder Anfang ist eine Chance."},
  {"id": 252, "text": "Veränderungen sind herausfordernd, PLACEHOLDER, aber bringen Wachstum."},
  {"id": 253, "text": "Es ist normal, sich unsicher zu fühlen, PLACEHOLDER. Gib dir Zeit, es wird besser."},
  {"id": 254, "text": "Hallo PLACEHOLDER! Nimm dir Zeit zum Ankommen."},
  {"id": 255, "text": "Unsicherheiten beim Umzug gehen vorbei, PLACEHOLDER. Du wirst es lieben!"},
  {"id": 256, "text": "Hey PLACEHOLDER, du bist nicht allein. Freunde warten auf dich."},
  {"id": 257, "text": "Es braucht Zeit, sich einzuleben, PLACEHOLDER. Hab Geduld, es wird besser."},
  {"id": 258, "text": "Glaub an dich, PLACEHOLDER! Du machst das großartig."},
  {"id": 259, "text": "Es ist okay, unsicher zu sein, PLACEHOLDER. Du machst das großartig!"},
  {"id": 260, "text": "Hey PLACEHOLDER, Veränderungen sind Chancen für Wachstum."},
  {"id": 261, "text": "Der Umzug ist schwer, PLACEHOLDER, aber du findest ein neues Zuhause."},
  {"id": 262, "text": "Hey PLACEHOLDER! Lass die Unsicherheit nicht die Freude überdecken."},
  {"id": 263, "text": "Die Anfangsphase ist herausfordernd, PLACEHOLDER, aber es wird besser. Bleib positiv!"},
  {"id": 264, "text": "Egal wie schwierig, PLACEHOLDER, du wirst gestärkt hervorgehen."},
  {"id": 265, "text": "Veränderungen lohnen sich, PLACEHOLDER. Halte durch, es wird vertraut."},
  {"id": 266, "text": "Hey PLACEHOLDER, jeder Tag bringt neue Möglichkeiten. Genieße die Reise!"},
  {"id": 267, "text": "Unsicherheiten sind vorübergehend, PLACEHOLDER. Bald wird es vertraut."},
  {"id": 268, "text": "Hey PLACEHOLDER, du bist mutig! Vertrau darauf, dass alles gut wird."},
  {"id": 269, "text": "Es ist normal, sich am Anfang unwohl zu fühlen, PLACEHOLDER. Es wird leichter."},
  {"id": 270, "text": "Du bist stärker, als du denkst, PLACEHOLDER! Vertrau auf deinen Weg."},
  {"id": 271, "text": "Hey PLACEHOLDER, jede Herausforderung ist eine Gelegenheit zum Wachsen."},
  {"id": 272, "text": "Veränderungen bringen Neues, PLACEHOLDER. Freu dich auf die Entdeckungen!"},
  {"id": 273, "text": "Hey PLACEHOLDER, du machst das großartig! Bald wird alles vertrauter sein."},
  {"id": 274, "text": "Unsicherheiten verblassen, PLACEHOLDER. Halte durch, es wird besser."},
  {"id": 275, "text": "Hey PLACEHOLDER, du bist nicht allein. Du hast Unterstützung auf deinem Weg!"}
];

const umzugEN = [
  {"id": 251, "text": "You've got this, PLACEHOLDER! Every beginning is a chance."},
  {"id": 252, "text": "Changes can be challenging, PLACEHOLDER, but they bring growth."},
  {"id": 253, "text": "It's normal to feel uncertain, PLACEHOLDER. Give it time, it'll get better."},
  {"id": 254, "text": "Hello PLACEHOLDER! Take time to settle in."},
  {"id": 255, "text": "Uncertainties with moving will pass, PLACEHOLDER. You'll love it!"},
  {"id": 256, "text": "Hey PLACEHOLDER, you're not alone. Friends await you."},
  {"id": 257, "text": "It takes time to adjust, PLACEHOLDER. Be patient, it'll improve."},
  {"id": 258, "text": "Believe in yourself, PLACEHOLDER! You're doing great."},
  {"id": 259, "text": "It's okay to be unsure, PLACEHOLDER. You're doing great!"},
  {"id": 260, "text": "Hey PLACEHOLDER, changes are opportunities for growth."},
  {"id": 261, "text": "Moving is tough, PLACEHOLDER, but you'll find a new home."},
  {"id": 262, "text": "Hey PLACEHOLDER! Don't let uncertainty overshadow the joy."},
  {"id": 263, "text": "The initial phase is challenging, PLACEHOLDER, but it gets better. Stay positive!"},
  {"id": 264, "text": "No matter how difficult, PLACEHOLDER, you'll emerge stronger."},
  {"id": 265, "text": "Changes are worth it, PLACEHOLDER. Hang in there, it'll become familiar."},
  {"id": 266, "text": "Hey PLACEHOLDER, each day brings new possibilities. Enjoy the journey!"},
  {"id": 267, "text": "Uncertainties are temporary, PLACEHOLDER. Soon, it'll be familiar."},
  {"id": 268, "text": "Hey PLACEHOLDER, you're brave! Trust that everything will be okay."},
  {"id": 269, "text": "It's normal to feel uncomfortable at first, PLACEHOLDER. It gets easier."},
  {"id": 270, "text": "You're stronger than you think, PLACEHOLDER! Trust your path."},
  {"id": 271, "text": "Hey PLACEHOLDER, every challenge is an opportunity to grow."},
  {"id": 272, "text": "Changes bring something new, PLACEHOLDER. Look forward to discoveries!"},
  {"id": 273, "text": "Hey PLACEHOLDER, you're doing great! Soon, everything will be more familiar."},
  {"id": 274, "text": "Uncertainties fade, PLACEHOLDER. Hang in there, it gets better."},
  {"id": 275, "text": "Hey PLACEHOLDER, you're not alone. You have support on your journey!"}
];
...
const  findMessageById = (messageId, mId, name, selectedLanguage) => {
  let messagesArray;
  let skipAutoText;

  if (mId === "1" || mId === "2" || mId === "3" || mId !== "4" || mId === "5"
  || mId === "6" || mId === "7" || mId === "8" || mId === "9" || mId === "10" 
  || mId === "11" || mId === "12" || mId === "13" || mId !== "14" || mId === "15"
  || mId === "16" || mId === "17" || mId === "18") {
    skipAutoText = true;
  }
  ...
  try {
      const resultObject = messagesArray.find(item => item.id === parseInt(messageId, 10));
      if (resultObject) {
        return resultObject.text.replace("PLACEHOLDER", name);
      } else {
        return messageId;
      }
  }
...
const getMessages = async () => {
  try {
    ...
    if (secretKeyString) {
      ...
      const response = await fetch('https://binaramics.com:5173/getMessages/', {
      method: 'POST',
      headers: {
...
export default function ChatScreen() {
  ...
  const getTimeAgo = (timestamp, lang = 'en') => {
    const now = new Date();
    const messageTime = new Date(timestamp);
    const timeDifference = (now - messageTime) / (1000 * 60);
  
    const getLocalizedString = (key, count) => {
      ...
      const translationKey = count === 1 ? key : `${key}s`; 
      const translation = translations[lang][translationKey] || key;
    ...
    if (lang === 'de') {
      if (timeDifference < 1) {
        ...
        result = `vor ${getLocalizedString('Sekunden', seconds)}`;
      } else if (timeDifference < 60) {
        
        result = `vor ${getLocalizedString('Minuten', Math.floor(timeDifference))}`;
      } else if (timeDifference < 1440) {
        const hours = Math.floor(timeDifference / 60);
        if(hours === 1) {
          result = `vor ${getLocalizedString('Stunde', hours)}`;
        }
        else {
        result = `vor ${getLocalizedString('Stunden', hours)}`;
        }
      } else {
        const days = Math.floor(timeDifference / 1440);
        console.log(days);
        if(days === 1) {
          result = `vor ${getLocalizedString('Tag', days)}`;
        } else{
        result = `vor ${getLocalizedString('Tagen', days)}`;
        }
      }
    } else if (lang === 'en') {
      if (timeDifference < 1) {
        const seconds = Math.floor(timeDifference * 60);
        result = `${getLocalizedString('seconds', seconds)} ago`;
      } else if (timeDifference < 60) {
        result = `${getLocalizedString('minutes', Math.floor(timeDifference))} ago`;
      } else if (timeDifference < 1440) {
        const hours = Math.floor(timeDifference / 60);
        result = `${getLocalizedString('hours', hours)} ago`;
      } else {
        const days = Math.floor(timeDifference / 1440);
        result = `${getLocalizedString('days', days)} ago`;
      }
    }
  ...
  return (
    <SafeAreaView style={{ flex: 1, marginBottom: ios ? -8 : 0 }}>
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <View style={{ paddingHorizontal: 15, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <Text style={{ color: themeColors.text, fontSize: 24, fontWeight: 'bold', marginTop: 10, marginBottom: 20 }}>
            {t('chat.title')}
          </Text>
        </View>
      </View>
                  ...
                  <View style={styles.messageBox}>
                    ...
                    <View style={styles.messageContent}>
                      <View style={styles.nameAndTimestamp}>
                        <Text style={styles.nameText}>{message.SENDER_USERNAME}</Text>
                      </View>
                      ...
                      <Text style={styles.timestampText}>
                        {getTimeAgo(message.TIMESTAMP, t('chat.lang'))}
                      </Text>
                    </View>
                  </View>
                </View>
